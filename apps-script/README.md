...
Fonte do AUTENTIKO 2.5.2. O arquivo `.clasp.json` real não é versionado.

A versão 2.5.2 mantém a Carta de Clientes deduplicada por CPF/CNPJ, a base de imóveis,
...
7. após o primeiro setup da 2.5.2, execute `migrarBaseCadastros` uma vez para consolidar os processos legados.
